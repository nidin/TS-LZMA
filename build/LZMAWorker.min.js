...
d})(nid||(nid={}));(function(c){var d=function(){function b(){this.command=0;var a=this;this.decoder=new c.LZMA;addEventListener("message",function(b){0==a.command?a.command=b.data:1==a.command?a.command=0:2==a.command&&a.decode(b.data)},!1)}b.prototype.decode=function(a){a=this.decoder.decode(new Uint8Array(a));postMessage(b.DECODE);postMessage(a.buffer,[a.buffer])};b.ENCODE=1;b.DECODE=2;return b}();c.LZMAWorker=d})(nid||(nid={}));new nid.LZMAWorker;
